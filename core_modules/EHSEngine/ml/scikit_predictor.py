...
class ScikitAQIPredictor(PredictorStrategy):
    """
    Scikit-learn based forecasting strategy.
    Loads a pre-trained regression model (.joblib) and predicts the next
    environmental reading based on a rolling window of historical values.
    """

    MODEL_NAME = "scikit-learn"

    def __init__(self, model_path: str = "./models/aqi_forecast.joblib"):
        self._model = None

...
────────────────────────
This abstract class is the "Strategy" interface. The EHSEvaluator never
...
class PredictorStrategy(ABC):
    """
    Abstract base strategy for EHS metric forecasting.
    ...
    def predict(self, historical_data: List[float], metric_name: str) -> ForecastResult:
        ...
        Args:
            ...
            metric_name:      The metric being forecast, e.g. "aqi" or "water_ph".
